...
export const MODEL_META: Record<string, ModelMeta> = {
  ...
  "UMA-s-1.2":        { elements: 89,   params_M: 290,   train_M: 484,  lot: "ωB97M-V/def2-TZVPD",     charges: true,  permissive: true,  note: "Mixture of Experts; 6M active params per forward pass" },
  "UMA-m-1.1":        { elements: 89,   params_M: 1400,  train_M: 484,  lot: "ωB97M-V/def2-TZVPD",     charges: true,  permissive: true,  note: "Mixture of Experts; 50M active params per forward pass" },
