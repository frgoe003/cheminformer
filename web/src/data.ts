...
export const MODEL_META: Record<string, ModelMeta> = {
  ...
  "UMA-s-1":        { elements: 89,   params_M: 150,   train_M: 484,  lot: "ωB97M-V/def2-TZVPD",     charges: true,  permissive: true  },
  "UMA-m-1":        { elements: 89,   params_M: 1400,  train_M: 484,  lot: "ωB97M-V/def2-TZVPD",     charges: true,  permissive: true  },
